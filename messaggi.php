		...
		<div class="form-style">
			...
			<div class="tabbable tabs-left">
				<ul class="nav nav-tabs">
					<li class="active">
						<a href="#inbox" id="inboxToggle" class="boxToggle" data-toggle="tab" data-id="inbox" style="width:130px;">Posta in arrivo </a>	
					</li>
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="span6">
						...
						<div id="oggetto">
							<input type="text" name="oggetto" class="input-level" style="width:400px;" placeholder="Oggetto">
						</div>
					</div>
					<div class="span6">
						<font size="3"><b>Messaggio: </b></font>
						<div id="descrizione">
							<textarea name="descrizione" rows="6" style="min-width:450px; max-width:450px;" placeholder="Inserisci il messaggio..."></textarea>
						</div>
					</div>
				</div><br>
			</div>
			<div class="modal-footer">
				<button class='btn' data-dismiss='modal' aria-hidden='true'>Annulla</button><button type='submit' class='btn btn-primary'> Invia </button>
			</div>
		</form>
	</div>
