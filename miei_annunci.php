...
<form action="miei_annunci_show.php" id="ricerca" class="form-style">
    ...
    <div class="row">
        ...
        <div class="span2">
            <button type="submit" class="btn" style="width: 80px">Cerca</button>
...
<div id="edit" class="modal modal-style hide fade">
    <form action="miei_annunci_edit.php" id="editform">
        <div class="modal-header">
            ...
            <h5>Titolo</h5>
            <div id="nome"><input type="text" name="nome" class="input-level"></div>
        </div>
        <div class="modal-body">
            <div class="row">
                ...
                <div class="span3">
                    <h5>Opzioni</h5>
                    <div id="telefono"><label class='checkbox'><input type="checkbox" id="telefono" name="telefono"
                                                                      value="1"> Mostra il numero di telefono</label>
                    </div>
                    <label class='checkbox'><input type="checkbox" name="email" value="1"> Mostra la tua email</label>
                    <div id="mappa"><label class='checkbox'><input type="checkbox" name="mappa" value="1"> Mostra la
                            mappa in cui si trova l'oggetto</label></div>
                </div>
            </div>
            <br>
            <div class="row">
