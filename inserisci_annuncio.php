...
<form action="inserisci_annuncio_process.php" id="insAnnuncio" class="form-style" method="post">
    ...
    <div class="row">
        <div class="span6">
            ...
            <h5>Descrizione</h5>
            <div id="descrizione"><textarea name="descrizione" rows="6" style="min-width:400px; max-width:400px;"
                                            placeholder="Inserisci la descrizione..."></textarea></div>
        </div>
        <div class="span6">
            <div id="nome"><h5>Titolo</h5><input type="text" name="nome" class="input-block-level" placeholder="Titolo"
            ...
            <div id="telefono"><label class='checkbox'><input type="checkbox" name="telefono" value="1"> Mostra il
                    numero di telefono</label></div>
            <label class='checkbox'><input type="checkbox" name="email" value="1"> Mostra la tua email</label>
            <div id="mappa"><label class='checkbox'><input type="checkbox" name="mappa" value="1"> Mostra la mappa di
                    dove si trova l'oggetto</label></div>
            <div align="right">
                <br><br><br>
                <button class="btn btn-large btn-primary" style="width:200px;" type="submit">Inserisci Annuncio</button>
            </div>
        </div>
    </div>
</form>
...
<form action="inserisci_annuncio_imgupload.php" id="imgupload" target="upload_target" method="post"
