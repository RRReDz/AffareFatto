...
<div id="wrap">	
	<header style="background-color: #f5f5f5;" >
		<div class="container">
			<h1>Affare Fatto</h1>
			<p class="lead">Scopri, compra, vendi</p>
		</div>
	</header>
		
	<div class="container" style="min-width:1000px; min-height:500px;">
		
		<table>
			<tr><td class="carousel-style" style="vertical-align:top;">
				<!-- Carousel -->
				<div id="myCarousel" class="carousel slide" style="margin:0 auto">
					<div class="carousel-inner">
						...
						<div class="item" style="width:550px; height:400px;">
							<img src="img/Hydrangeas.jpg" alt="" style="width:100%; height:100%;">
							<div class="container">
								<div class="carousel-caption" style="height:140px;">
									<h1>Iscriviti oggi</h1>
									<p class="lead">Contenuto 3</p>
									<br><a class="btn btn-large btn-primary" href="#">Browse gallery</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="tab-content">
						...
						<div class="tab-pane active" id="accedi">
							<form id="form" action="index_autenticazione.php" class="form-inline">
								<fieldset>
									<div id="nomeutente" ><h5>Nome Utente</h5><input type="text" name="nomeutente" class="input-block-level" placeholder="Nome Utente"></div>
									<div id="pass"><h5>Password</h5><input type="password" name="pass" class="input-block-level" placeholder="Password"></div><br>
									<label class="checkbox">
										<input name="rememberMe" type="checkbox" value="1"> Resta collegato
									</label><br><br>
									<a href="#"> Hai dimenticato la password? </a><br><br>
									<button type="submit" class="btn btn-block btn-primary">Accedi</button><br><br>
								</fieldset>
							</form>
						</div>
						<!-- Registrazione -->
						<div class="tab-pane" id="regis">
							<form id="signup" action="index_registrazione.php" class="form-inline">
									<div class="row">
										<div id="cognome" class="span2"><h5>Cognome</h5><input type="text" name="cognome" class="input-block-level" placeholder="Cognome"></div>
										<div id="nome" class="span2"><h5>Nome</h5><input type="text" name="nome" class="input-block-level" placeholder="Nome"></div>
									</div>
									<div class="row">
										<div id="email" class="span4"><h5>E-Mail</h5><input type="email" name="email" class="input-block-level" placeholder="E-Mail"></div>
									</div>
									<div class="row">
										<div id="username" class="span3"><h5>Username</h5><input type="text" name="username" class="input-block-level" placeholder="Username"></div>
									</div>
									<div class="row">
										<div id="password" class="span2"><h5>Password</h5><input type="password" name="password" class="input-block-level" placeholder="Password"></div>
										<div id="password_check" class="span2"><h5>Verifica</h5><input type="password" name="password_check" class="input-block-level" placeholder="Password"></div>
									</div><br><br>
